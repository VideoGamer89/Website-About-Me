<?php
	...
	$navigation_6 = $_GET['Favorite TV Shows'];
	$navigation_7 = $_GET['Favorite Foods'];
	$navigation_8 = $_GET['Favorite Restaurants'];
	$navigation_9 = $_GET['Favorite Video Games'];
		...
		<div id = "page">
			...
			<div id = "nav">
				<ul>
					...
					<li><a href="Website About Me - Favorite TV Shows.php"><?php echo $navigation_6; ?></a></li>
					<li><a href="Website About Me - Favorite Foods.php"><?php echo $navigation_7; ?></a></li>
					<li><a href="Website About Me - Favorite Restaurants.php"><?php echo $navigation_8; ?></a></li>
					<li><a href="Website About Me - Favorite Video Games.php"><?php echo $navigation_9; ?></a></li>
