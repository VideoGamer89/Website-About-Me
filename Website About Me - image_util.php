<?php
  function process_image($dir, $filname) {
		...
		// Set up the read pathinfo
		$image_path = $dir . DIRECTORY_SEPARATOR . $filname;
	...
	function resize_image($old_image_path, $new_image_path,
		...
		if ($width_ratio > 1 || $height_ration > 1) {
			...
			// Set transparency to image type
			if ($image_type == IMAGETYPE_GIF) {
				$alpha = imagecolorallocate($new_image, 0, 0, 0, 127);
			...
			$image_to_file($new_file, $new_image_path);
