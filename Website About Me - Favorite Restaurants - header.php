<?php
	...
	$navigation_4 = $_GET['Favorite Movies'];
	$navigation_5 = $_GET['Favorite Bands'];
	...
	$navigation_11 = $_GET['Image Galery']
		...
		<div id = "page">
			...
			<div id = "nav">
				<ul>
					...
					<li><a href="Website About Me - Favorite Movies.php"><?php echo $navigation_4; ?></a></li>
					<li><a href="Website About Me - Favorite Bands.php"><?php echo $navigation_5; ?></a></li>
