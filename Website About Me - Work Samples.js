function WorkSamplesProcess()
{
	...
	string = "<ul>"
		...
		+ "</ul>"
		+ "<p>I transcribed podcast interviews and tested the Basic Business Course, ensuring absence of errors involving webpages and / or broken links.";
	// obtain a reference to the <div>
	myDiv = document.getElementById("myDivWorkSampleElement");
