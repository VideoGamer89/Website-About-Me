<?php
	...
	$navigation_1 = $_GET['Hobbies'];
	$navigation_2 = $_GET['Favorite Music'];
...
<html>
	...
	<body>
		...
		<div id = "page">
			...
			<div id = "nav">
				<ul>
					<li><a href="Website About Me - Hobbies.php"><?php echo $navigation_1; ?></a></li>
					<li><a href="Website About Me - Favorite Music.php"><?php echo $navigation_2; ?></a></li>
					<li><a href="Website About Me - Favorite Bands.php"><?php echo $navigation_3; ?></a></li>
					<li><a href="Website About Me - Favorite Video Games.php"><?php echo $navigation_4; ?></a></li>
					<li><a href="Website About Me - Favorite Gaming Consoles.php"><?php echo $navigation_5; ?></a></li>
					<li><a href="Website About Me - Favorite Movies.php"><?php echo $navigation_6; ?></a></li>
					<li><a href="Website About Me - Favorite TV Shows.php"><?php echo $navigation_7; ?></a></li>
					...
					<li><a href="Website About Me - Favorite Beverage.php"><?php echo $navigation_17; ?></a></li>
