function FavoriteBandsProcess()
{
	...
	string = "<table>"
			...
			+ "<tr>"
				...
				+ "<td>42</td>"
				+ "<td>None</td>"
				+ "<a href=" + "Website About Me - Resources.html" + ">6</a>, <a href=" + "Website About Me - Resources.html" + ">7</a></td>"
			+ "</tr>"
			+ "<tr>"
			...
			+ "<tr>"
				...
				+ "<td><a href=" + "Website About Me - Resources.html" + ">25</a>, <a href=" + "Website About Me - Resources" + ">26</a></td>"
			+ "</tr>"
			+ "<tr>"
				+ "<td>Foo Fighters</td>"
