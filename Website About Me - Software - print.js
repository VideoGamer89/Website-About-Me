function SoftwareProcess()
{
  ...
  string = "<table border = " + "3" + ">"
			...
			+ "<tr>"
				...
				+ "<td>Trialware</td>"
				+ "<td>IA-32, x64</td>"
				+ "<td><a href=" + "Website About Me - Works Cited - print.html" + ">3</a></td>"
			+ "</tr>"
			+ "<tr>"
				...
				+ "<td>None</td>"
				+ "<td>None</td>"
				+ "<td><a href=" + "Website About Me - Works Cited - print.html" + ">4</a></td>"
			+ "</tr>"
			+ "<tr>"
				+ "<td>Notepad++</td>"
				+ "<td>Don Ho</td>"
				...
				+ "<td>IA-32, x86-64</td>"
				+ "<td><a href=" + "Website About Me - Works Cited - print.html" + ">5</a></td>"
			+ "</tr>"
			+ "<tr>"
				...
				+ "<td><a href=" + "Website About Me - Works Cited - print.html" + ">6</a></td>"
			+ "</tr>"
			+ "<tr>"
				...
				+ "<td>None</td>"
				+ "<td>None</td>"
				+ "<td><a href=" + "Website About Me - Works Cited - print.html" + ">7</a></td>"
			+ "</tr>"
			+ "<tr>"
				...
				+ "<td><a href=" + "Website About Me - Works Cited - print.html" + ">8</a></td>"
			+ "</tr>"
			+ "<tr>"
				+ "<td>Google Chrome</td>"
				+ "<td>Google Inc.</td>"
				...
				+ "<td>None</td>"
				+ "<td><a href=" + "Website About Me - Works Cited - print.html" + ">9</a></td>"
			+ "</tr>"
			+ "<tr>"
				...
				+ "<td>Freemium</td>"
				+ "<td>None</td>"
				+ "<td><a href=" + "Website About Me - Works Cited - print.html" + ">10</a></td>"
			+ "</tr>"
			+ "<tr>"
