		...
		<div id = "page">
			...
			<div id = "nav">
				<ul>
					...
					<li><a href="Website About Me - Favorite Movies.php"><?php echo $navigation_6; ?></a></li>
					...
					<li><a href="Website About Me - Favorite Restaurants.php"><?php echo $navigation_10; ?></a></li>
					<li><a href="Website About Me - Favorite Stores.php"><?php echo $navigation_11; ?></a></li>
					<li><a href="Website About Me - Image Gallery.php"><?php echo $navigation_12; ?></a></li>
					<li><a href="Website About Me - Work Samples.php"><?php echo $navigation_13; ?></a></li>
					...
					<li><a href="Website About Me - Works Cited.php"><?php echo $navigation_18; ?></a></li>
				</ul>
			</div><!-- end nav -->
