		...
		<div id = "page">
			...
			<div id = "nav">
				<ul>
					...
					<li><a href="Website About Me - Favorite Movies.php"><?php $navigation_5; ?></a></li>
					<li><a href="Website About Me - Favorite Video Games.php"><?php $navigation_6; ?></a></li>
					<li><a href="Website About Me - Favorite Gaming Consoles.php"><?php $navigation_7; ?></a></li>
