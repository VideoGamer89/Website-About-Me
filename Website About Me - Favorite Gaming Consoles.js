function FavoriteGamingConsolesProcess()
{
	...
	string = "<table>"
			...
			+ "<caption>Favorite Gaming Consoles</caption>"
				...
				+ "<th>Date(s) of Discontinuation</th>"
			...
			+ "<tr>"
				...
				+ "<td>None</td>"
				+ "<td><a href=" + "Website About Me - Works Cited.html" + ">5</a>, <a href=" + "Website About Me - Works Cited.html" + ">6</a>, <a href=" + "Website About Me - Works Cited.html" + ">7</a></td>"
			+ "</tr>"
			+ "<tr>"
			...
			+ "<tr>"
				...
				+ "<td><a href=" + "Website About Me - Works Cited.html" + ">11</a>, <a href=" + "Website About Me - Works Cited.html" + ">12</a></td>"
			+ "</tr>"
			+ "<tr>"
				+ "<td>Nintendo GameCube (GCN)</td>"
				+ "<td>Nintendo</td>"
				+ "<td>Nintendo, Foxconn</td>"
				+ "<td>Home video game console</td>"
				...
				+ "<td>Dolphin OS</td>"
				+ "<td><a href=" + "Website About Me - Works Cited.html" + ">13</a>, <a href=" + "Website About Me - Works Cited.html" + ">6</a></td>"
			+ "</tr>"
			+ "<tr>"
				+ "<td>Nintendo Wii</td>"
				+ "<td>Nintendo</td>"
			...
			+ "<tr>"
				...
				+ "<td>None</td>"
				+ "<td><a href=" + "Website About Me - Works Cited.html" + ">15</a>, <a href=" + "Website About Me - Works Cited.html" + ">6</a></td>"
			+ "</tr>"
			+ "<tr>"
				+ "<td>Super Nintendo Entertainment System (SNES)</td>"
				+ "<td>Nintendo</td>"
				...
				+ "<td>None</td>"
				+ "<td>None</td>"
				+ "<td><a href=" + "Website About Me - Works Cited.html" + ">16</a>, <a href=" + "Website About Me - Works Cited" + ">6</a></td>"
			+ "</tr>"
			+ "<tr>"
				+ "<td>Game Boy Advance (GBA)</td>"
				+ "<td>Nintendo</td>"
				...
				+ "<td>June 11, 2001</td>"
				+ "<td>May 15, 2010</td>"
				+ "<td>Pok&eacute;mon Ruby and Sapphire</td>"
				+ "<td>81.51 Million</td>"
				+ "<td>$99.99</td>"
			...
			+ "<tr>"
				...
				+ "<td>None</td>"
				+ "<td>None</td>"
				+ "<td><a href=" + "Website About Me - Works Cited.html" + ">20</a>, <a href=" + "Website About Me - Works Cited.html" + ">6</a>"
			+ "</tr>"
		+ "</table>";
